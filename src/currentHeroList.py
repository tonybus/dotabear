...
hFile = urllib.request.urlopen(
    "http://api.steampowered.com/IEconDOTA2_570/GetHeroes/v0001/?language=en_us&key=%s&format=xml" % dotalib.apiKey)
hData = hFile.read()
hFile.close()
...
for hero in heroes:
    herolist[int(hero.getElementsByTagName("id")[0].firstChild.data) - 1] = hero.getElementsByTagName("localized_name")[
        0].firstChild.data
